...
### Step 2: Download [`environment.yml`](https://github.com/practicaldsc/practicaldsc.github.io/blob/main/resources/environment.yml)

[This file](https://github.com/practicaldsc/practicaldsc.github.io/blob/main/resources/environment.yml) contains the necessary details to configure your environment. If you take a look at it, you'll see that it contains a specific Python version (`python=3.10`) along with specific package versions (like `pandas==2.1.0` and `scikit-learn==1.5.1`, for example).
